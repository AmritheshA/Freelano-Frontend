...
const technologyIcons: Record<string, React.ReactElement> = {
  ...
  java: <FaJava className="text-orange-900" />,
  python: <FaPython className="text-[#3776AB]" />,
  php: <FaPhp className="text-[#4248a4]" />,
  ...
  database: <FaDatabase className="text-[#ff4dc1]" />,
