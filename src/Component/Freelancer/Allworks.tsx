...
=======
    ...
    const Menus = [
        ...
        { title: "All Jobs", src: <svg stroke="currentColor" fill="black" stroke-width="0" viewBox="0 0 1024 1024" height="1.5em" width="1.5em" xmlns="http://www.w3.org/2000/svg"><path d="M280 752h80c4.4 0 8-3.6 8-8V280c0-4.4-3.6-8-8-8h-80c-4.4 0-8 3.6-8 8v464c0 4.4 3.6 8 8 8zm192-280h80c4.4 0 8-3.6 8-8V280c0-4.4-3.6-8-8-8h-80c-4.4 0-8 3.6-8 8v184c0 4.4 3.6 8 8 8zm192 72h80c4.4 0 8-3.6 8-8V280c0-4.4-3.6-8-8-8h-80c-4.4 0-8 3.6-8 8v256c0 4.4 3.6 8 8 8zm216-432H144c-17.7 0-32 14.3-32 32v736c0 17.7 14.3 32 32 32h736c17.7 0 32-14.3 32-32V144c0-17.7-14.3-32-32-32zm-40 728H184V184h656v656z"></path></svg>, to: "/jobs" },
                ...
                <div className="h-full flex-1 p-7">
                    <div className="flex justify-end">
                        ...
                        <div className="flex items-center sm:mr-48 gap-10">
                            ...
                            <DropdownMenu>
                                <DropdownMenuTrigger>
                                    <div className={`w-10 h-10 rounded-full bg-cover bg-center bg-no-repeat`} style={{ backgroundImage: `url('${userInfo ? userInfo.profileImgUrl : './src/assets/freelancer/profileImage.png'}')` }}>
                                    </div>
                                </DropdownMenuTrigger>
                                <DropdownMenuContent>
                            ...
                            <div className="mt-28">
                                ...
                                <div className="w-full h-full flex gap-10 p-5  ">
                                    ...
                                    <div className="sm:w-[15%] mt-4 h-10 ">
                                        <div className="mb-10">
                                            <div className="flex justify-between items-center">
                                                <h1 className="clientFont font-semibold text-md">Experience level</h1>
                                                <IoIosArrowDown className={`cursor-pointer ${experienceToggle && 'rotate-180'}`} size={20} onClick={() => setExperienceToggle(!experienceToggle)} />
                                            </div>
                                            {experienceToggle && (
                                                <div className="flex flex-col ">
                                                    <div className="flex items-center pl-2 mt-2">
                                        ...
                                        <div className="mb-10">
                                            <div className="flex justify-between items-center">
                                                <h1 className="clientFont font-semibold text-md">Job type</h1>
                                                <IoIosArrowDown className={`cursor-pointer ${jobTypeToggle && 'rotate-180'}`} size={20} onClick={() => setJobTypeToggle(!jobTypeToggle)} />
                                            </div>
                                            {jobTypeToggle && (
                                                <div className="flex flex-col ">
                                                    <div className="mt-4">
                                        ...
                                        <div className="mb-10    ">
                                            <h1 className="clientFont font-semibold text-md">Category</h1>
                                            <Select>
                                                <SelectTrigger className="w-[220px] mt-4 border-2 outline-none border-gray-300">
                                                    <SelectValue placeholder="Select a category" />
                                                </SelectTrigger>
                                        ...
                                        <div className="mb-10">
                                            <div className="flex justify-between items-center">
                                                <h1 className="clientFont font-semibold text-md">Project length</h1>
                                                <IoIosArrowDown className={`cursor-pointer ${projectDurationToggle && 'rotate-180'}`} size={20} onClick={() => setProjectDurationToggle(!projectDurationToggle)} />
                                            </div>
                                            {projectDurationToggle && (
                                                <div className="flex flex-col ">
                                                    <div className="flex items-center pl-2 mt-2">
                                        ...
                                        <div className="mb-10    ">
                                            <h1 className="clientFont font-semibold text-md">Client location</h1>
                                            <Select>
                                                <SelectTrigger className="w-[220px] mt-4 border-2 outline-none border-gray-300">
                                                    <SelectValue placeholder="Select a category" />
                                                </SelectTrigger>
                                            ...
                                            <div className="flex justify-start mt-14">
                                                <Dialog>
                                                    ...
                                                    <DialogContent className="min-w-[35%]">
                                                        <DialogHeader>
                                                            <DialogTitle className="text-gray-400 text-xl">Job Details</DialogTitle>
                                                            <DialogDescription>
                                                                <div className="h-[700px]">
                                                                    ...
                                                                    <div className="flex gap-8 mt-14 items-center">
                                                                        ...
                                                                        <div>
                                                                            <p className="text-start text-black font-medium">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scraed </p>
                                                                        </div>
                                                                    </div>
                                                                    <div className="flex justify-end mt-14 gap-5 mr-10">
                                                                        <button className="bg-orange-600 text-white py-2 px-4 rounded-md focus:outline-none hover:bg-orange-800">Save Work</button>
                                                                        <button className="bg-blue-700 text-white py-2 px-4 rounded-md focus:outline-none hover:bg-blue-900">Apply Now</button>
                                                                    </div>
                                                                </div>
                                                            </DialogDescription>
                                                        </DialogHeader>
                    ...
                    <div className="flex justify-center mt-24">
                        <Pagination count={10} onChange={(_, page) => { console.log("pages..." + page); setCurrentPage(page) }} />
                    </div>
