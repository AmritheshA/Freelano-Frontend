  ...
  return (
    <div className="bg-white w-full h-screen ">
      ...
      <div className="flex flex-col">
        <div className="p-10 sm:pl-36 font-bold text-xl text-black ">2/7</div>
        ...
        <div className="absolute flex bottom-16 right-0">
          <button className="flex mr-5 sm:mr-10 justify-center items-center gap-2 border-2 text-black border-black w-40 h-12 rounded-3xl">
            Back
          </button>
          <button className="flex mr-5 sm:mr-10 justify-center items-center gap-2 text-black bg-orange-500 w-40 h-12 rounded-3xl">
