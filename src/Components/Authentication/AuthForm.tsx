...
function AuthForm({ flag }: { flag: boolean }) {
  ...
  const isLoaded = useSelector((state:RootState) => state.userDetails.loading);
          ...
          {({ isSubmitting }) => (
            <Form className="flex flex-col mt-20 max-w-full w-[410px] max-md:mt-10">
              ...
              <Field
                type="text"
                name="email"
                className="justify-center h-14 items-start py-2 pr-2 pl-6 mt-2 text-sm whitespace-nowrap bg-white rounded-3xl text-stone-500 font-bold max-md:px-5 outline-none border-none"
              ...
              <div className="relative flex">
                <Field
                  ...
                  name="password"
                  className="flex-1 px-6 py-4 pr-16 mt-2.5 text-sm whitespace-nowrap bg-white rounded-3xl text-stone-500 font-bold max-md:px-5 outline-none border-none"
